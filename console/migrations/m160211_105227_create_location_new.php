...
class m160211_105227_create_location_new extends Migration
{
    public function safeUp()
    {
        ...
        $this->createIndex('location_new_case_provider_latitude_longitude', 'location_new', ['case_id', 'provider_id', 'latitude', 'longitude'], true);

        $this->addForeignKey('location_new_user_id', 'location_new', 'user_id', 'user', 'id');
        $this->addForeignKey('location_new_case_id', 'location_new', 'case_id', 'case', 'id');
