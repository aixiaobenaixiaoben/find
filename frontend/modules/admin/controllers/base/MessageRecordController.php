...
use frontend\modules\admin\models\MessageRecordSearch;
...
/**
 * MessageRecordController implements the CRUD actions for MessageRecord model.
 */
class MessageRecordController extends Controller
{
    ...
    {
        $searchModel = new MessageRecordSearch;
